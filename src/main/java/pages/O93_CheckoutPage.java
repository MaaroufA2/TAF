...
public class O93_CheckoutPage extends O1_PageBase {
	public O93_CheckoutPage(WebDriver driver) {
		super(driver);
	}
	...
	public void RegisteredUserCheckoutProduct(String countryName, String address, String postcode, String phone,
